...
public class TarefasApp extends Application {
    ...
    public void start(Stage palco) throws Exception {
        ...
        cena.getStylesheets().add(getClass().getResource("GUI/view/style.css").toExternalForm());
        ...
        palco.getIcons().add(new Image(getClass().getResourceAsStream("GUI/view/icon.png")));
        palco.setScene(cena);
